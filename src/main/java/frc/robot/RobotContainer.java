...
import frc.robot.subsystems.elevator.Commands.ChangeHeight;
...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        a.whenPressed(new ChangeHeight(elevator, Constants.Elevator.MAXIMUM_HIGHT));
        b.whenPressed(new ChangeHeight(elevator, Constants.Elevator.MINIMUM_HIGHT));
