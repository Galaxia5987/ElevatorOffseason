...
public class RobotContainer {
    public static XboxController xbox = new XboxController(XBOX_CONTROLLER);
    public static JoystickButton x = new JoystickButton(xbox, XboxController.Button.kX.value);
    public static JoystickButton y = new JoystickButton(xbox, XboxController.Button.kY.value);
    public static JoystickButton b = new JoystickButton(xbox, XboxController.Button.kB.value);
    public static JoystickButton a = new JoystickButton(xbox, XboxController.Button.kA.value);
    public static JoystickButton start = new JoystickButton(xbox, XboxController.Button.kStart.value);
    public static JoystickButton back = new JoystickButton(xbox, XboxController.Button.kBack.value);
